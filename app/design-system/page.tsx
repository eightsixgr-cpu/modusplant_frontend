              ...
              >
                ...
                <div className="grid gap-5 lg:grid-cols-2">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div
                        ...
                        data-inspect-label="Textarea preview / Counter"
                        data-inspect-kind="Field wrapper"
                        data-code-path="app/design-system/page.tsx#textarea-preview"
                      ...
                      >
                        <div className="relative">
                          <textarea
                            ...
                            data-inspect-label="Textarea / Counter preview"
                            data-inspect-kind="Textarea preview"
                            data-code-path="app/design-system/page.tsx#textarea-preview"
                            data-storybook-path="pending"
                            className={getInspectClassName(
                              'textarea.counter',
                              'border-surface-stroke-2 text-neutral-20 placeholder:text-neutral-70 min-h-30 w-full resize-none rounded-lg border px-4 py-4 pb-9 text-[16px] leading-[1.2] tracking-[-0.01em] transition-colors outline-none focus:border-primary-50'
                            )}
                          />
                          <span className="text-text-muted absolute right-4 bottom-3 text-sm">
                            0/120
                          </span>
                        </div>
                      </div>
                  ...
                  <div
                    ...
                    data-inspect-kind="Component group"
                    data-inspect-description="Search preview, category filter, Dropdown 묶음의 spacing을 실측합니다."
                    data-code-path="app/design-system/page.tsx#search-preview"
                    data-storybook-path="pending"
                    className={getInspectClassName(
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div
                        ...
                        data-inspect-label="Search preview / Default"
                        data-inspect-kind="Search preview"
                        data-code-path="app/design-system/page.tsx#search-preview"
                        data-storybook-path="pending"
                        className={getInspectClassName(
                          'searchbar.default',
                      ...
                      >
                        <label className="border-surface-stroke focus-within:border-primary-50 flex h-[49px] w-full min-w-[240px] items-center gap-2.5 rounded-full border px-4 py-[15px]">
                          <Search
                            className="text-neutral-20 h-4 w-4 shrink-0"
                            aria-hidden="true"
                          />
                          <input
                            type="text"
                            placeholder="식물 이름, 게시글 검색"
